defmodule PacketflowChat.Accounts.User do
  ...
  """
  def valid_password?(%PacketflowChat.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def validate_current_password(changeset) do
    if valid_password?(changeset.data, changeset.params["current_password"]) do
      changeset
    else
  ...
  defp maybe_hash_password(changeset, opts) do
    ...
    if hash_password? && password && changeset.valid? do
      ...
      # Hashes the password and stores it in the :hashed_password field
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, PacketflowChat.Repo)
      |> unique_constraint(:email)
    else
      changeset
    end
