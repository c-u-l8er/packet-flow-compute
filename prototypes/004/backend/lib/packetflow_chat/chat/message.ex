defmodule PacketflowChat.Chat.Message do
  ...
  def changeset(message, attrs) do
    ...
    max_length = case message_type do
      ...
      "ai_response" -> 5000    # AI responses can be longer
      "ai_command" -> 2000     # AI commands can be longer
    ...
    |> validate_inclusion(:message_type, ["text", "image", "file", "ai_capability", "ai_command", "ai_response"])
  end
end
